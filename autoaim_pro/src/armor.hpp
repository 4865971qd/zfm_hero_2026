...
struct Armor {
    ...
    std::vector<Eigen::Vector3d> xyz_in_camera_candidates;
    std::vector<Eigen::Vector3d> xyz_in_gimbal_candidates;
    std::vector<Eigen::Vector3d> xyz_in_world_candidates;
    std::vector<Eigen::Vector3d> ypr_in_gimbal_candidates;
    std::vector<Eigen::Vector3d> ypr_in_world_candidates;
    std::vector<double> pnp_reprojection_errors;
    int selected_pose_idx = 0;
    double pose_ambiguity = 0.0;
